...
public:
     ...
     */
    void handle_mousewheel_event(lz::Entity &player, lz::Event &event);

    /**
     * Handles mouse clicks.
     */
    void handle_mouse_click_event(lz::Entity &player, lz::Event &event);

    /**
     * Handles mouse movement.
     */
    void handle_mouse_movement_event(lz::Entity &player, lz::Event &event);
